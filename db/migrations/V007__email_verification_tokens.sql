...
--
-- Purpose:   Stores SHA-256 hashed email-verification tokens.  Issued
--            at registration, each token is single-use and time-limited
--            (24 hours).  The plain-text token is sent to the user via
--            email; only the hash is stored in the database.
--
